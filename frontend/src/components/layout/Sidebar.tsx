  ...
  return (
    <div className={cn("flex flex-col h-full bg-card border-r border-border", className)}>
      ...
      <div className="flex-1 overflow-y-auto py-6 px-3 space-y-1">
        <p className="px-4 text-xs font-bold text-muted-foreground uppercase tracking-wider mb-2">Menu Utama</p>
        ...
        <div className="pt-6">
           <p className="px-4 text-xs font-bold text-muted-foreground uppercase tracking-wider mb-2">Akun</p>
           <Link to="/profile" onClick={onClose}>
            ...
            >
              <User className={cn("h-5 w-5", isActive('/profile') && "fill-current")} />
              Profile
            </Button>
           </Link>
        </div>
      ...
      <div className="p-4 border-t border-border/50 bg-secondary/20">
        <div className="flex items-center gap-3 mb-4 p-2">
           ...
           <div className="flex-1 min-w-0">
             ...
             <p className="text-xs text-muted-foreground truncate">Mahasiswa</p>
           </div>
        </div>
